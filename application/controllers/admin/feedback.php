...
class Feedback extends CI_Controller {
    ...
    public function page($page = 'feedback', $msg = null) {
        ...
        if (!$msg) {
            $data['msgs'] = $this->feedback_model->get_msgs();
            $data['title'] = 'Обратная свзяь';
            $this->load->view('admin/templates/metahead', $data);
            $this->load->view('admin/templates/navbar', $data);
            $this->load->view('admin/pages/settings/templates/left-nav', $data);
            ...
            $data['msg'] = $this->feedback_model->get_msgs($msg);
            $data['title'] = 'Обратная свзяь';
            $this->load->view('admin/templates/metahead', $data);
            $this->load->view('admin/templates/navbar', $data);
            $this->load->view('admin/pages/settings/templates/left-nav', $data);
    ...
    public function setread() {
        ...
        if ($this->input->post('id')) {
            ...
            $this->feedback_model->update_feedback_read($id);
        }
    }
    
    public function delete($id) {
        $this->feedback_model->feedback_delete($id);
        redirect('admin/settings/feedback');
    }
