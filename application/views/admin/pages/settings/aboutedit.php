<div class="col-md-10">
    ...
    <div class="page-header">
        <h2>Редактирование текста на странице "О нас"</h2>
    </div>
    <?= form_open_multipart('admin/settings/about/edit') ?>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                <label for="text">Текст главной страницы</label>
    ...
    <div class="row" style="margin-top: 10px;">
        <div class="col-md-12">
            <input type='hidden' name='do' value='aboutEdit'>
