            ...
            foreach ($msgs as $msg):
                ...
                <tr>
                    ...
                    <td><?php
                        ...
                        ?></td>
                    <td><a href="/admin/settings/backcall/<?= $msg['id'] ?>"><span class="glyphicon glyphicon-share"></span></a></td>
                    <td><a href="/admin/settings/backcall/delete/<?= $msg['id'] ?>"><span class="glyphicon glyphicon-trash"></span></a></td>
                </tr>
                <?php
            endforeach;
        } else {
