...
/* acp_update.html */
class __TwigTemplate_645abaae663a49541e65881dfb8d137c extends Twig_Template
{
...
";
        ...
        $context['_seq'] = twig_ensure_traversable($this->getAttribute($_loops_, "updates_available"));
...
\t\t\t<dd><strong>";
            ...
            echo $this->getAttribute($_updates_available_, "current");
            echo "</strong></dd>
\t\t</dl>
\t\t<dl>
\t\t\t<dt><label>";
...
\t\t\t<dd><strong><a href=\"";
            // line 36
            if (isset($context["updates_available"])) { $_updates_available_ = $context["updates_available"]; } else { $_updates_available_ = null; }
            echo $this->getAttribute($_updates_available_, "announcement");
            echo "\">";
            if (isset($context["updates_available"])) { $_updates_available_ = $context["updates_available"]; } else { $_updates_available_ = null; }
            echo $this->getAttribute($_updates_available_, "announcement");
            echo "</a></strong></dd>
