...
$lang = array_merge($lang, array(
	...
	'ACC_ACTIVATION_EXPLAIN'			=> 'Эта группа настроек определяет, могут ли пользователи иметь доступ к конференции сразу после регистрации или для этого требуется подтверждение регистрации. Также здесь можно полностью отключить регистрацию новых пользователей. <em>Функция «Включить email-сообщения» должна быть включена для использования возможности активации новых учётных записей пользователем или администратором.</em>',
	'ACC_ACTIVATION_WARNING'			=> 'Учтите, что текущий метод активации новых пользователей требует включения email-сообщений на конференции, в противном случае регистрация будет недоступна. Рекомендуется выбрать другой метод активации, или включить email-сообщения.',
