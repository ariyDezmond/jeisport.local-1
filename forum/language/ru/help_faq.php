...
$help = array(
	...
	array(
		...
		1 => 'Возможно, администратор конференции отключил регистрацию новых пользователей. Также возможно, что он заблокировал ваш IP-адрес или запретил имя, под которым вы пытаетесь зарегистрироваться. Обратитесь за помощью к администратору конференции.',
	),
	array(
	...
	array(
		...
		1 => 'Если вы являетесь зарегистрированным пользователем, все ваши настройки хранятся в базе данных конференции. Чтобы изменить их, щёлкните на имени пользователя вверху страницы и перейдите по ссылке <em>Личный раздел</em>. Там вы можете изменить все свои настройки и предпочтения.'
	),
	array(
		0 => 'Как избежать появления моего имени в списке «Кто сейчас на конференции»?',
		1 => 'На вкладке «Личные настройки» в личном разделе вы найдёте опцию <em>Скрывать моё пребывание на конференции</em>. Выберите <em>Да</em>, и вы будете видны только администраторам, модераторам и самому себе. Для всех остальных вы будете скрытым пользователем.'
	),
	array(
	...
	array(
		...
		1 => 'Вы можете найти свои сообщения, щёлкнув по ссылке «Показать ваши сообщения» в личном разделе на главной странице, по ссылке «Найти сообщения пользователя» на странице вашего профиля на конференции или по ссылке «Ваши сообщения» в меню «Ссылки» на главной странице. Чтобы найти созданные вами темы, используйте страницу расширенного поиска, заполнив соответствующие поля.'
	),
	array(
		0 => '--',
